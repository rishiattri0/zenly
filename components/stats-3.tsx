        ...
        <section className="bg-background @container pt-24">
            <div className="mx-auto max-w-2xl px-6">
                <div className="space-y-4">
                    <h2 className="text-balance text-4xl font-medium lg:text-5xl">Supporting Your Wellness Journey</h2>
                    <p className="text-muted-foreground text-balance">Our platform provides measurable results that help individuals find balance and improve their mental well-being.</p>
                </div>
                <div className="@xl:grid-cols-3 mt-12 grid gap-6 text-sm">
                    <div className="border-t py-6">
                        <p className="text-muted-foreground text-xl">
                            <span className="text-foreground font-medium">95%</span> Report improved mood.
                        </p>
                    </div>

                    <div className="border-t py-6">
                        <p className="text-muted-foreground text-xl">
                            <span className="text-foreground font-medium">1M+</span> Mindful moments tracked.
                        </p>
                    </div>

                    <div className="border-t py-6">
                        <p className="text-muted-foreground text-xl">
                            <span className="text-foreground font-medium">50K+</span> Daily active users.
                        </p>
                    </div>
                </div>
            </div>
